...
const Tasks = () => {
  ...
  const handleComplete = async (task) => {
    try {
      const res = await updateTaskAPI(task.id, {
    ...
    <div className="flex min-h-screen bg-[#0B1120] overflow-hidden">
      ...
      <main className="lg:ml-64 flex-1 p-4 sm:p-6 lg:p-8 pt-24 lg:pt-8 relative">
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
          ...
          {/* Progress */}
          <div className="bg-linear-to-br from-indigo-500/10 to-violet-500/10 backdrop-blur-xl border border-indigo-500/20 rounded-[28px] p-5 sm:p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-4xl p-4 sm:p-6 lg:p-8 shadow-2xl mb-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Add productivity goals and work items.
              </p>
            </div>
          </div>
                ...
                {pendingTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span
                        className={`inline-flex mt-3 px-3 py-1 rounded-full border text-xs ${priorityStyles[task.priority]}`}
                      >
                        {task.priority}
                      </span>
                    </div>
                ...
                {completedTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-400 font-medium line-through wrap-break-word">
                        {task.title}
                      </p>
